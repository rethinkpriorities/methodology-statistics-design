...
and cases: prediction, causal inference, statistical inference and updating, dimension reduction and recovering 'factors'...^[As always, focus on 'what repeatedly comes up in our work', linking the practical cases]
