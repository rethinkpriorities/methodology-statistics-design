...
We will run a comparison of two independent samples, and seek to assess our capacity to detect (or rule out?) a range of possible effect sizes, considering Cohen's $d$ at 0, .15, .3.
