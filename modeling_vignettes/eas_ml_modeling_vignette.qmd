...
Normally we would set a large number of iterations, but as this is a vignette we set it to 4 iterations only. It still takes a few minutes
...
We want to know how good our models are predicting the training data (the data that was not used to fit these models). 
