...
<!--chapter:end:introduction_overview.Rmd-->
...
<!--chapter:end:experiments_trials_design.Rmd-->

# BASIC STATISTICS: MODELING, TESTING AND INFERENCE {-}

<!--chapter:end:basic_stats.Rmd-->
...
<!--chapter:end:causal_inf.Rmd-->

# MONTE-CARLO 'FERMI ESTIMATION' APPROACHES* {-#fermi} 

<!--chapter:end:fermi.Rmd-->
