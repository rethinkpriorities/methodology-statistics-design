# 3: Sampling the Imaginary (posterior) {#mcelreath_ch3}

> This chapter teaches you basic skills for working with samples from the posterior distribution. 

McElreath thinks the 'suprising Bayesian updating' of the AIDS test/vampire trope example is not helpful. Thinking in *frequencies* rather than rates is more intuitive and useful. 


> Out of these 1094 positive tests, 95 of them are real vampires, so that implies...

> called the frequency format or natural frequencies. 
^["Why a frequency format helps people intuit the correct approach remains contentious.]
