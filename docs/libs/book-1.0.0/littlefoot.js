!(function (e, t) {
      ...
      t.pixels = function e(t, n) {
        var r,
          ...
          l =
            null !==
              (o =
                null === (r = null == n ? void 0 : n.ownerDocument) ||
                void 0 === r
                  ? void 0
          ...
          f =
            ...
            [
              u,
              (null !== (i = null == c ? void 0 : c[1]) && void 0 !== i
                ? i
                : ""
              ).toLowerCase(),
            ]),
        ...
        switch (f[1]) {
          ...
          case "vmin":
            return (
              (d *
                Math.min(
                  l.innerWidth || s.clientWidth,
                  l.innerHeight || s.clientHeight
                )) /
              100
            )
          case "vmax":
  ...
  function w(e) {
    ...
    if (window.innerWidth > 768) {
      if (document.body.classList.contains("sb-sidenav-toggled")) {
        ...
        sidebarWidth = document.getElementById("TOC").clientWidth
      }
    }

    var t = parseFloat(g.getStyle(e, "marginLeft")),
      n = e.offsetWidth - t - sidebarWidth
      ...
      resize: function () {
        ...
        S(p) &&
          ((p.style.left =
            ...
            (r = d.offsetWidth),
            -w(n) * r +
              parseInt(g.getStyle(n, "marginLeft"), 10) +
              n.offsetWidth / 2 +
              "px")),
    ...
    h = function (r) {
      return function (e) {
        ...
        0 < n && b(r, o),
          t &&
            n <= 0 &&
            n < t.clientHeight + t.scrollTop - t.scrollHeight &&
            v(r, o)
      }
    }
  ...
  function s(e) {
    ...
    var n =
      null == t
        ? void 0
        : t.innerHTML.replace("[]", "").replace("&nbsp;", " ").trim()
    t && !n && s(t)
  }
    ...
    function o(e) {
      return function (t) {
        n.allowMultiple ||
          ...
          t.isReady() &&
            (t.activate(n.activateCallback),
            t.reposition(),
            t.resize(),
            setTimeout(t.ready, e))
      }
    }
        ...
        return (
              ...
              for (
                ...
                (i = (l = c[r]).key),
                  (a = (function (e, t) {
                    ...
                    (((a = Object.create(o)).map = new p()), s.push(a)),
          ...
          (e.prototype.queryAll = function (e) {
            ...
            for (
              ...
              for (
                r = l[s], t = 0, n = (o = this.matches(r)).length;
                t < n;
                t++
              )
                u[(a = o[t]).id]
