...
*Some sections shared shared with the [EA Marketing Team Gitbook](https://effective-giving-marketing.gitbook.io/untitled/)*
...
## Sections and organization {#outline_sections}^[Proposed/discussed below -- keep updated with actual structure]

**[DATA, CODE](#data)** ^[ Note that the capital letters denote the highest-level sections, but in the markdown these are at the same level as the sections below
]
