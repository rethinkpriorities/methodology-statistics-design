...
- [Jamie Elsey's code example](bayes_odds_ratio.R): `bayes_odds_ratio.R`
...
- `bayesAB` is easy to apply, allows flexible specification of priors (and has tools to help you decide on these), and generates very clear output and graphs. See  [vignette](http://frankportman.github.io/bayesAB/)
