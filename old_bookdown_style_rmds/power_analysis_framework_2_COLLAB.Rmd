...
linear.reg.maker <- function(data, breaks, group = "group") {
...
four.group.lin.summary <- linreg.output %>% 
  group_by(group, interval, cell.size) %>%
...
(
power_curve <-  four.group.lin.summary %>%
ggplot() +
